const portfolio_data = [
  ...
  // Website Design
  {
    ...
    sm_text: 'At CodyFox we specialize in designing, building, shipping...',
  ...
  {
    id: 32,
    img: '/assets/img/portfolio/site1.jpg',
    title: 'Hotel Magazine',
    subtitle: 'Ui/Ux Design',
    link:'https://hotelmagazine.co.nz/',
    category: 'Website',
    portfolio_2: true,
  },
  {
    id: 33,
    img: '/assets/img/portfolio/site2.jpg',
    title: 'Craft courses',
    subtitle: 'Development',
    link:'https://www.craftcourses.com/',
    category: 'Website',
    portfolio_2: true,
  },
  {
    id: 34,
    img: '/assets/img/portfolio/site3.jpg',
  ...
  {
    id: 35,
    img: '/assets/img/portfolio/site4.jpg',
    title: 'Health Haven Hospital',
    subtitle: 'Development',
    link:'https://healthcare-service-react-app.web.app/',
    category: 'Website',
    portfolio_2: true,
  },
  // {
  ...
  // category Mobile App
  {
    ...
    link:'https://play.google.com/store/apps/details?id=com.mightybeargames.mah',
    category: 'Mobile App',
    portfolio_2: true,
  },
  // {
  ...
  //   title: 'Run Race 3D Stickman Battles',
  //   subtitle: 'Mobile Game',
  //   category: 'Mobile App',
  //   portfolio_2: true,
  // },
  {
    ...
    title: 'Fun Merge 3D',
    subtitle: 'Mobile Game',
    link:'https://play.google.com/store/apps/details?id=com.rubygames.emojichallenge',
    category: 'Mobile App',
    portfolio_2: true,
  },
  {
    id: 48,
    img: '/assets/img/portfolio/app.png',
    title: 'SIGN.PLUS - eSign & Fill Docs',
    subtitle: 'Mobile App',
    link:'https://play.google.com/store/apps/details?id=plus.sign.android',
    category: 'Mobile App',
    portfolio_2: true,
  },
  {
    id: 49,
    img: '/assets/img/portfolio/app2.png',
    title: 'Gallery',
    subtitle: 'Mobile App',
    link:'https://play.google.com/store/apps/details?id=com.photo.vault.hdgallery',
    category: 'Mobile App',
    portfolio_2: true,
  },
  // portfolio page 2
  ...
  // service page recent product
  {
    ...
    subtitle:<>At CodyFox we specialize in designing, building, <br/> shipping and scaling beautifu</>,
    duration:'.3s',
    delay:'.5s',
    service_p: true,
  },
