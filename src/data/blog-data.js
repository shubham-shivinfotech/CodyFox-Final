const blog_data = [
  {
    ...
    short_desc:"At CodyFox we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration:'.6s',
    delay:'.4s',
    home:true,
  },
  ...
  // home three
  {
    ...
    short_desc:"At CodyFox we specialize in designing, building, shipping and scaling beautiful",
    duration:'.3s',
    delay:'.6s',
    home_3:true,
  },
  ...
  // home 4
  {
    ...
    views:'1,426',
    title:'Godaddy user flow solution.',
    short_desc:"At CodyFox we specialize in designing, building, shipping and scaling beautifu. At CodyFox we specialize in designing, building, shipping and scaling beautiful.",
    big:true,
    home_4:true,
  },
  {
