...
const hero_contents = {
  title: <>Providing top-notch <span className="tp-highlight"> <HighlightSix /> <i>IT solutions</i>
  </span> with maximum satisfaction</>,
  sm_text: <>At CodyFox, we excel in designing, building, shipping, and scaling beautiful, user-friendly products and services, providing real-time solutions to clients worldwide with unparalleled efficiency.</>,
