      ...
      <div className="container tp-industri-bg">
        ...
        <div className="row justify-content-center tp-industri-space">
          <div className="col-12">
            <IndustryItem duration={'.3s'} delay={'.5s'} title={'Android Studio'} />
            <IndustryItem duration={'.5s'} delay={'.7s'} number={'one'} title={'XCode'} />
            <IndustryItem duration={'.7s'} delay={'.9s'} number={'two'} title={'Flutter'} />
            <IndustryItem duration={'.9s'} delay={'1s'} number={'eight'} title={'React Native'} />
            <IndustryItem duration={'1s'} delay={'1.1s'} number={'four'} title={'Kotlin'} />
            <IndustryItem duration={'1.1s'} delay={'1.2s'} number={'five'} title={'Java'} />
            <IndustryItem duration={'1.2s'} delay={'1.3s'} number={'six'} title={'Dart'} />
            <IndustryItem duration={'1.3s'} delay={'1.3s'} number={'two'} title={'Node JS'} />
            ...
            <IndustryItem duration={'1.3s'} delay={'1.3s'} number={'one'} title={'FireBase'} />
            <IndustryItem duration={'1.3s'} delay={'1.3s'} number={'one'} title={'JavaScript API'} />
            <IndustryItem duration={'1.2s'} delay={'1.3s'} number={'two'} title={'Expo'} />
