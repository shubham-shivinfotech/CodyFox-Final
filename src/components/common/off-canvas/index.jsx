      ...
      <div className="tp-offcanvas-area">
        <div className={`tpoffcanvas ${isOpen ? 'opened' : ''}`}>
          ...
          <div className="tpoffcanvas__contact">
            ...
            <ul>
              <li>
                <i className="fas fa-star"></i> <a href="https://g.co/kgs/fpzeyWB" rel="noreferrer" target="_blank">145 Platinum point, Near Sudama Chowk Mota-varachha, Surat</a>
              </li>
              <li><i className="fas fa-star"></i><a href="tel:7069927889">+91 7069927889</a></li>
              <li><i className="fas fa-star"></i><a href="mailto:codyfoxinfotech@gmail.com">Codyfoxinfotech@gmail.com</a></li>
            </ul>
          </div>
